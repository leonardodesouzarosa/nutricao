...
<div class="row mt-4 mb-4">
    <a type="button" class="btn-success btn-sm ml-3 d-none d-md-block" href="index.php?pag=<?php echo $pag ?>&funcao=novo">Novo Nutricionista</a>
        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                   ...
                   $query = $pdo->query("SELECT * FROM NUTRICIONISTA AS N INNER JOIN PESSOA AS P ON P.ID = N.CODPESSOA order by NOME");
                   ...
                   for ($i=0; $i < count($res); $i++) { 
                    ...
                    <tr>
                        ...
                        <td><img src="../img/nutricionistas/<?php echo $foto ?>" width="50"></td>
                        <td>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                if (@$_GET['funcao'] == 'editar') {
                    ...
                    $editar = $pdo->query("SELECT * FROM NUTRICIONISTA AS N INNER JOIN PESSOA AS P ON P.ID = N.CODPESSOA WHERE CODPESSOA = '$id2' order by NOME");
            ...
            <div class="row">
                <div class="col">
                 <div class="form-group">
                    <label >CRN</label>
                    <input value="<?php echo @$edtCrn ?>" type="text" class="form-control" id="crn" name="crn" placerholder="CRN">
                </div>
            </div>
    </div>
...
<div class="col-md-4">
    ...
    <div id="divImgConta">
        <?php if(@$edtFoto != ""){ ?>
            <img src="../img/nutricionistas/<?php echo $edtFoto ?>"  width="100%" id="target">
        <?php  }else{ ?>
            <img src="../img/nutricionistas/sem-foto.jpg" width="100%" id="target">
        <?php } ?>
    </div>
</div>
</div>
...
<div class="modal" id="modal-endereco" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Dados do Nutricionista</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <?php 
                    if (@$_GET['funcao'] == 'endereco') {
                        ...
                        $query = $pdo->query("SELECT * FROM NUTRICIONISTA AS N INNER JOIN PESSOA AS P ON P.ID = N.CODPESSOA WHERE CODPESSOA = '$id2'");
                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        </span><span><b>CRN: </b> <i><?php echo $crn3 ?></i></span> <span class="ml-4"><b>Sexo: </b> <i><?php echo $sexo3 ?></i> </span>
                    ...
                    <div class="col-md-5">
                        ...
                        <img src="../img/nutricionistas/<?php echo $foto3 ?>" width="100%">
