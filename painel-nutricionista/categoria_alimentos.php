...
<div class="row mt-4 mb-4">
    <a type="button" class="btn-success btn-sm ml-3 d-none d-md-block" href="index.php?pag=<?php echo $pag ?>&funcao=novo">Novo Categoria</a>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                if (@$_GET['funcao'] == 'editar') {
                    ...
                    $query = $pdo->query("SELECT * FROM CATEGORIA_ALIMENTO WHERE ID = '" . $id2 . "' ");
                    $res = $query->fetchAll(PDO::FETCH_ASSOC);
