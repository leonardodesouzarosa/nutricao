<?php 
    ...
    $pag = @$_GET["pag"];
    $menu1 = "nutricionistas";
    $menu2 = "pacientes";
    $menu3 = "alimentos";
    $menu4 = "categoria_alimentos";
    $menu5 = "refeicao";
    $menu6 = "cardapio";
...
<html lang="pt-br">
    ...
    <head>
        ...
        <script src="../vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
         ...
         <link rel="shortcut icon" href="../img/Nova Pasta/Icons.png" type="image/x-icon">
    <link rel="icon" href="../img/Nova Pasta/Icons.png" type="image/x-icon">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                    ...
                    <div class="sidebar-brand-text mx-3">Nutricionista</div>
                </a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu1 ?>">Nutricionistas</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu2 ?>">Pacientes</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
                        ...
                        <span>Alimentos / Refeição</span>
                    </a>
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Dados:</h6>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu3 ?>">Alimentos</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu4 ?>">Tipo de Alimentos</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu5 ?>">Refeição</a>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                       ...
                       <!--<img class="mt-1" src="../img/Logo.png" width="78"> -->
                       <img class="mt-1" src="../img/Icons.png" width="78">
                    ...
                    <div class="container-fluid">
                        ...
                        } else if (@$pag=='ver-paciente') {
                        @include_once("ver_paciente.php");
                ...
                <div class="modal-content">
                    ...
                    <form id="form-perfil" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            ...
                            <input value="<?php echo $id_usuario ?>" type="hidden" name="id_usuario" id="id_usuario">
                            <input value="<?php echo $cpf ?>" type="hidden" name="antigo_usu" id="antigo_usu">
